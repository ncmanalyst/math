# Math: Aprendizaje lúdico de matemáticas
...
3. No requiere instalación adicional ni conexión a internet (modo offline).

## Para docentes
Incluye sección de configuración para ajustar dificultad, límite de tiempo y seguimiento de aciertos/errores. Los resultados se pueden exportar en formato CSV.

## 📄 Licencia
MIT – libre para uso educativo y adaptaciones no comerciales.

---

**Repositorio en construcción activa** – Próximos juegos: estadística descriptiva y operaciones con enteros negativos.
